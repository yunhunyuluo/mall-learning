 ...
 */
package com.linsh.mall.tiny.direct;
...
public class DirectRabbitConfig {
    ...
    @Bean
    public com.linsh.mall.tiny.direct.DirectReceiver receiver() {
        return new com.linsh.mall.tiny.direct.DirectReceiver();
    }


    @Bean
    public com.linsh.mall.tiny.direct.DirectSender directSender() {
        return new com.linsh.mall.tiny.direct.DirectSender();
    }
